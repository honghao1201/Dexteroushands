...
try:
    ...
    from rl.pose_approach_env import AeroPoseApproachEnv
...
def collect_rollout(model_path: pathlib.Path, seed: int):
    ...
    base = DummyVecEnv([lambda: AeroPoseApproachEnv()])
...
class ReplayWindow:
    ...
    def __init__(self, sim, frames, fps: int = 20):
        ...
        self.root = tk.Tk()
        self.root.title("PoseApproach 阶段三视图进度回放")
